...
import {type IShoppingListMember, shoppingListMemberSchema} from "./shopping-list-member.schema.ts";
...
export interface IShoppingList {
    ...
    members: Array<IShoppingListMember>;
    created_at: Date;
    updated_at: Date;
    complete_by: Date;
    closed_at: Date|null;
...
const shoppingListSchema = new Schema<IShoppingList, TShoppingListModel>({
    ...
    members: { type: [shoppingListMemberSchema], required: true, default: [] },
